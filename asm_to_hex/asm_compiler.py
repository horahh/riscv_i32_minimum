...
def asm_to_hex(asm_instructions,toml_file):
    hex_instructions = [] 
    descriptor = InstructionDescriptor(instruction_set_obj)
...
def asm_to_binary( asm_file, bin_file, toml_file):
    instruction_set = InstructionSet(toml_file)
    asm_instructions = get_asm_instructions(asm_file)
    int_instructions = asm_to_hex(asm_instructions, toml_file)
