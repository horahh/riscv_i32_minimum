...
def test_reg_sum():
    ...
    int_instruction_decode = asm.instruction_decode(instruction_type, instructions_description)
    hex_instruction_decode = afd.int_to_32bit_hex_instruction(int_instruction_decode)
